...
- Use declarative style for helpers, with minimal/optional arguments: `user()` instead of `create_user(name="")`
- Prefer regular functions over fixtures, as fixture scope is messy and global.
